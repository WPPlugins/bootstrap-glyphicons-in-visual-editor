...
Plugin URI: http://509tech.com/bootstrap-glyphicons-wordpress-plugin/
...
{
	wp_register_style( 'bootstrap-min-css', plugins_url( '/css/bootstrap.min.css', __FILE__ ), array(),'3.0', 'all' );  
